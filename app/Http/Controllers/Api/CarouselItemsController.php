...
use App\Models\CarouselItems; // Import model
use Illuminate\Http\Request;
use App\Http\Requests\CarouselItemsRequest; // Import request
...
// Terminal: php artisan make:controller Api/CarouselItemsController --resource